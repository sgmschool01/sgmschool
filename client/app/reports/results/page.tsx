...
export default function ResultsReportPage() {
    ...
    useEffect(() => {
        ...
        fetch(`${process.env.NEXT_PUBLIC_API_URL || "https://sgmschool.onrender.com"}/academic/years`).then(r => r.json()).then(data => {
            setYears(data);
    ...
    useEffect(() => {
        ...
        setFilteredTerms([]);
        if (yearId) {
            fetch(`${process.env.NEXT_PUBLIC_API_URL || "https://sgmschool.onrender.com"}/academic/terms/${yearId}`)
                .then(r => r.json())
    ...
    const loadReport = async () => {
        ...
        try {
            ...
            const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL || "https://sgmschool.onrender.com"}/reports/results?${params}`);
                ...
                <div className="card-body">
                    <div className="row g-2 g-md-3 align-items-end">
                        ...
                        <div className="col-12 col-md-4 d-flex gap-2">
                            <button className="btn btn-sm fw-bold px-4 flex-grow-1" style={{ background: 'var(--primary-teal)', color: '#fff', height: 34, borderRadius: 10 }} onClick={loadReport} disabled={loading || !yearId}>
                    ...
                    <div className="card-body p-0">
                        <div ref={printRef}>
                            ...
                            <div className="table-responsive">
                                <table className="table table-hover mb-0 results-table" style={{ fontSize: 13 }}>
                                    <thead>
                                        <tr>
